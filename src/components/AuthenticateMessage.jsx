...
export default function AuthenticateMessage({ redirectUri, displayAuthMessage, setDisplayAuthMessage }) {
  //<!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
  const unsplashIcon = <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M448 230.2V480H0V230.2H141.1V355.1H306.9V230.2zM306.9 32H141.1V156.9H306.9z"/></svg>;
    ...
    <>
      {displayAuthMessage && (
        <div className="flex items-center justify-center min-h-screen fixed bg-ntrl-clr-200 bg-opacity-40 inset-0">
          ...
          <HeadingSmall text='Login using unsplash to view and manage your collections' />
            <GrayButton text={'Login'} icon={unsplashIcon} callback={() => {redirectToAuth(redirectUri)}}/>
          </div>
        </div>
      )
      }
